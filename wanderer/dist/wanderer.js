...
var require_wanderer_image = __commonJS2({
  "../plugins/image/dist/wanderer-image.js"(exports2, module2) {
    ...
    var import_path3 = __toESM3(require("path"));
...
var streamFrontmatter = async (filename) => {
  let startToken = "";
  const fileStream = import_fs4.default.createReadStream(import_upath3.default.resolve(filename));
...
var getTextAfterFrontmatter = (filename) => {
  const text3 = import_fs4.default.readFileSync(import_upath3.default.resolve(filename), "utf-8");
  let startToken = "";
  if (text3.startsWith("---")) {
    startToken = "---";
  ...
  async generateConfig() {
    ...
    for (let file of allFiles) {
      ...
      if (ext.toLocaleLowerCase() !== ".toml") {
        ...
        const contents = import_fs5.default.readFileSync(import_upath5.default.resolve(this.siteInfo.contentDirectory, file), "utf-8");
        if (name === `_`) {
...
var Site = class {
  ...
  async make() {
    ...
    for (let file of staticFiles) {
      ...
      if (!import_fs6.default.existsSync(import_upath6.default.dirname(targetFile))) {
        import_fs6.default.mkdirSync(import_upath6.default.dirname(targetFile), { recursive: true });
      }
      import_fs6.default.copyFileSync(import_upath6.default.resolve(this.staticDir, file), targetFile);
    }
