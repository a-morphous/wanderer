...
var require_wanderer_image = __commonJS2({
  "../plugins/image/dist/wanderer-image.js"(exports2, module2) {
    ...
    var import_path4 = __toESM3(__require("path"));
...
var _readdirSyncRecursive = function(dirPath, _originalDirPath, arrayOfFiles = []) {
  ...
  files.forEach(function(file) {
    if (fs2.statSync(path3.join(dirPath, file)).isDirectory()) {
      arrayOfFiles = _readdirSyncRecursive(path3.join(dirPath, file), originalDirPath, arrayOfFiles);
    } else {
      arrayOfFiles.push(path3.normalize(path3.relative(originalDirPath, path3.join(dirPath, file))));
    }
  });
  return arrayOfFiles;
};
...
var streamFrontmatter = async (filename) => {
  let startToken = "";
  const fileStream = fs3.createReadStream(import_upath4.default.resolve(filename));
...
var getTextAfterFrontmatter = (filename) => {
  const text3 = fs3.readFileSync(import_upath4.default.resolve(filename), "utf-8");
  let startToken = "";
  if (text3.startsWith("---")) {
    startToken = "---";
  ...
  async generateConfig() {
    ...
    for (let file of allFiles) {
      ...
      if (ext.toLocaleLowerCase() !== ".toml") {
        ...
        const contents = fs4.readFileSync(import_upath6.default.resolve(this.siteInfo.contentDirectory, file), "utf-8");
        if (name === `_`) {
...
var Site = class {
  ...
  async make() {
    ...
    for (let file of staticFiles) {
      ...
      if (!fs5.existsSync(import_upath7.default.dirname(targetFile))) {
        fs5.mkdirSync(import_upath7.default.dirname(targetFile), { recursive: true });
      }
      fs5.copyFileSync(import_upath7.default.resolve(this.staticDir, file), targetFile);
    }
...
var main = async () => {
  Logger.set(2 /* WARN */);
  const siteConfig = {
    contentDirectory: path8.resolve(__dirname, "..", "test", "content"),
    frameDirectory: path8.resolve(__dirname, "..", "test", "frame"),
    buildDirectory: path8.resolve(__dirname, "..", "build", "test"),
    cacheDirectory: path8.resolve(__dirname, "..", "build", ".cache"),
    siteConfiguration: {}
  };
  wanderer(siteConfig);
};
